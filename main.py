...
fs.add_file(['dir3', 'backup', '2024'], FSNode.create_file('log1.txt', 30, {'extension': 'txt'}))
fs.add_file(['dir3', 'backup', '2024'], FSNode.create_file('log2.txt', 40, {'extension': 'txt'}))
fs.add_file(['dir3', 'backup', '2024'], FSNode.create_file('log3.txt', 30, {'extension': 'txt'}))
